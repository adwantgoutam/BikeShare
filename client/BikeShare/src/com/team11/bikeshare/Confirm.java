...
public class Confirm extends CommonMenu {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		client.get("http://10.0.0.36:8080/bike",params, new AsyncHttpResponseHandler(){
	...
	OnClickListener Confirm = new OnClickListener() {
        public void onClick(View v) {
        	...
        	AsyncHttpClient client = new AsyncHttpClient();
    		client.post("http://10.0.0.36:8080/confirm_rent",params, new AsyncHttpResponseHandler(){
    			public void onSuccess(int statuscode,String response)
    			{
